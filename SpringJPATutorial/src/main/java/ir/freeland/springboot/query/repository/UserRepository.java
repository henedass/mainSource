package ir.freeland.springboot.query.repository;
...
@Repository
public interface UserRepository extends JpaRepository<User, Integer>, UserRepositoryCustom , QueryByExampleExecutor<User> {
    ...
    List<User> findAllUsersWithPaginationNative(Pageable pageable);
